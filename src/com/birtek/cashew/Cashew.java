...
public class Cashew {
    ...
    public static CAHGameManager cahGameManager;
    ...
    public static void main(String[] args) {
        ...
        commands.addCommands(
                ...
                Commands.slash("counting", "Manages the counting game")
                        ...
                        .addSubcommands(new SubcommandData("mute", "Mute or unmute a user in the counting game")
                                .addOption(USER, "user", "User to mute"))
                        .setDefaultPermissions(moderatorPermissions)
                        .setGuildOnly(true),
                ...
                Commands.slash("reactionroles", "Create an embed from which members can obtain roles by reacting")
                        .addSubcommands(new SubcommandData("create", "Creates the ReactionRoles embed")
        ...
        cahGameManager = new CAHGameManager();
